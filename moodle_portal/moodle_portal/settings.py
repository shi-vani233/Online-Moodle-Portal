"""
Django settings for moodle_portal project.
...
SECRET_KEY = '+v=eu-vgctw6y^=y0@sasjgz0yoyek0lraa*^0@5_)l%yj4sf*'
...
ROOT_URLCONF = 'moodle_portal.urls'
...
WSGI_APPLICATION = 'moodle_portal.wsgi.application'
